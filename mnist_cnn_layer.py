...
using high-level library tf.layers
The achieved accuracy is ~ 97.45%
"""
...
def cnn_model_fn(features, labels, mode):
    ...
    # Pooling Layer #1with my_graph.as_default():
    # First max pooling layer with a 2x2 filter and stride of 2
    # Input Tensor Shape: [batch_size, 28, 28, 32]features
