...
my_head_pose_estimator.load_pitch_variables(os.path.realpath("/home/lhuynh/Desktop/deepgaze/etc/tensorflow/head_pose/pitch/cnn_cccdd_30k.tf"))
my_head_pose_estimator.load_yaw_variables(os.path.realpath("/home/lhuynh/Desktop/deepgaze/etc/tensorflow/head_pose/yaw/cnn_cccdd_30k"))
